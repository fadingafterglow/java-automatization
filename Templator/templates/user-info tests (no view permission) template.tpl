...
public class [:main-h-ns:]CRUDTest extends BaseTest {
    ...
    private void mockPermissions() {
        mockUserPermissions(canDoEverythingEmail, PermissionsEnum.CREATE_[:main-u-su:], PermissionsEnum.EDIT_[:main-u-su:], PermissionsEnum.DELETE_[:main-u-su:]);
    ...
    @ParameterizedTest
    @ValueSource(strings = {TEACHER_EMAIL, FACULTY_STAFF_EMAIL, EMPLOYEE_EMAIL})
    public void everyoneCanViewEntityById(String user) {
        [:main-h-ns:]View view = getRandom[:main-h-ns:]View(user);
        Integer id = baseCRUDMethods.createRequest(view, canDoEverythingEmail);

        [:main-h-ns:]Response response = baseCRUDMethods.getInfoAsObject(id, canDoNothingEmail, [:main-h-ns:]Response.class);
    ...
    @ParameterizedTest
    @ValueSource(strings = {TEACHER_EMAIL, FACULTY_STAFF_EMAIL, EMPLOYEE_EMAIL})
    public void everyoneCanViewEntitiesByEmail(String user) {
        [:main-h-ns:]View view = getRandom[:main-h-ns:]View(user);
        int id = baseCRUDMethods.createRequest(view, canDoEverythingEmail);

        [:main-h-ns:]ListResponse response = baseCRUDMethods.getAsObject("/user/" + user, canDoNothingEmail, [:main-h-ns:]ListResponse.class);
    ...
    @Test
    public void everyoneCanViewEntitiesByCriteria() {
    ...
    private [:main-h-ns:]ListResponse getListResponseByCriteria([:main-h-ns:]Criteria criteria) {
        return baseCRUDMethods.getListResponseByCriteria(canDoNothingEmail, criteria, [:main-h-ns:]ListResponse.class);
    }
